...
int main(int argc, char *argv[])
{
	...
	printer::inst()->print_str("XMR-Stak Clean mining software, RX460 Version.\n");
	printer::inst()->print_str("AMD mining code was written by wolf9466.\n");
	printer::inst()->print_str("Brought to you by malvanos under GPLv3.\n\n");
	printer::inst()->print_str("Not dev donation is available.\n");
